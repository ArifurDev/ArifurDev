...
<h1 align="center">Arifur Rahman Rifat</h1>
...
<p align="center">
I build <strong>secure</strong>, <strong>scalable</strong>, and <strong>production-ready</strong> backend systems using Laravel.
</p>

<p align="center">
<strong>Laravel</strong> · <strong>REST APIs</strong> · <strong>Stripe Payments</strong> ·
<strong>AWS Cloud</strong> · <strong>Deployment & Performance</strong>
</p>
...
I’m a **Laravel Backend Developer** experienced in building real-world applications for companies and clients.  
My core strength lies in **backend architecture, API development, payment systems, and cloud deployment**.

I focus on writing clean, maintainable code and designing systems that work reliably in real production environments.
